...
let japa = [
{
		src: 'https://aramajapan.com/wp-content/uploads/2017/04/aramajapan_album_07-e1492306072398.jpg',
		no: 'Arte na Capa de Disco: 🇯🇵 Japão',
		des: 'Jun Togawa – Tamahime Sama ★1984',
	},
	{
		src: 'https://aramajapan.com/wp-content/uploads/2017/04/aramajapan_album_04-1.jpg',
		no: 'Arte na Capa de Disco: 🇯🇵 Japão',
		des: 'Tomomi Kahala – storytelling ★1997',
	},
	{
		src: 'https://aramajapan.com/wp-content/uploads/2017/04/aramajapan_album_02.jpg',
		no: 'Arte na Capa de Disco: 🇯🇵 Japão',
		des: 'Do As Infinity – Ariadne no Ito (2011)',
	},
	{
		src: 'https://i.discogs.com/t3XWfS_Ukcx-sG5DbC-3diw26sVCpiajosMAR58Wo5M/rs:fit/g:sm/q:90/h:600/w:600/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTIyMjA0/MDktMTU2NDEwMTg0/MC03NDUxLmpwZWc.jpeg',
		no: 'Arte na Capa de Disco: 🇯🇵 Japão',
		des: 'Mariya',
	},
	{
		src: 'https://i.discogs.com/5Z7alWPpTp3kZsgZwy2VpUwslPfj1dxvg2LENA7ZFkg/rs:fit/g:sm/q:90/h:600/w:599/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTE0MzE2/NzY1LTE1NzIxMDAw/MDctNjQzMC5qcGVn.jpeg',
		no: 'Arte na Capa de Disco: 🇯🇵 Japão',
		des: 'Anywhere',
	},
	{
		src: 'https://i.scdn.co/image/ab67616d0000b2737909eb5c1d8b701285576ff9',
		no: 'Arte na Capa de Disco: 🇯🇵 Japão',
		des: 'Kokusyoku',
	},
	{
		src: 'https://musiconcd.eu/wp-content/uploads/2017/10/8718627222287.jpg',
		no: 'Arte na Capa de Disco: 🇯🇵 Japão',
		des: 'YMO',
	},
	{
		src: 'https://image.biccamera.com/img/00000003039513_A01.jpg?sr.dw=600&sr.jqh=60&sr.dh=600&sr.mat=1',
		no: 'Arte na Capa de Disco: 🇯🇵 Japão',
		des: 'Ali Project',
	},
	{
		src: 'https://i.discogs.com/vZ7PdoFdq1AoCaWRzfkGQ342k2AOLcCNmLYe8jMHLR0/rs:fit/g:sm/q:90/h:589/w:580/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9SLTQzNjE3/NTUtMTM2Mjg0MjYy/Ny02Nzg0LmpwZWc.jpeg',
		no: 'Arte na Capa de Disco: 🇯🇵 Japão',
		des: 'Jefferson Airplane',
	},
	{
		src: 'https://i.ebayimg.com/images/g/kCUAAOSwK3tiM2Nb/s-l1600.jpg',
		no: 'Arte na Capa de Disco: 🇯🇵 Japão',
		des: 'Godzilla',
	},
];
...
let selo = [
	{
		...
		no: 'Selos / Gravadoras',
		des: 'Eldorado. artistas como Raul Seixas, Ratos de Porão, Daniela Mercury... | pt.wi',
	},
	{
		src: 'thumb320x180.png',
		no: 'Selos / Gravadoras',
		des: 'Discos Marcus Pereira',
	},
	{
...
/*
	{
		src: 'https://i.discogs.com/3kNKjUaVXqf3NSZYOj7amvUJJBcXdS9RJZazhd7yqQQ/rs:fit/g:sm/q:40/h:300/w:300/czM6Ly9kaXNjb2dz/LWRhdGFiYXNlLWlt/YWdlcy9MLTE4MDU4/NDMtMTU4NjUzMjAx/Ni00NDg1LmpwZWc.jpeg',
		no: 'Selos / Gravadoras',
		des: 'Ministério da Educação e Cultura. | discogs',
	},
	{
		src: 'https://upload.wikimedia.org/wikipedia/pt/thumb/6/61/Elizete-cardoso-cancao.jpg/220px-Elizete-cardoso-cancao.jpg',
		no: 'Selos / Gravadoras',
		des: 'Gravadora Festa, criada na déc. de 1950, no Rio de Janeiro, pelo jornalista paulista Irineu Garcia. | usp.br',
	},
	{
		src: 'https://discografia.discosdobrasil.com.br/storage/capas/DI03816.jpg',
		no: 'Selos / Gravadoras',
		des: 'Funarte/Atração Fonográfica/Instituto Itaú Cultural',
	},
	{
		src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Logoeldorado.jpg/265px-Logoeldorado.jpg',
		no: 'Selos / Gravadoras',
		des: 'Eldorado. artistas como Raul Seixas, Ratos de Porão, Daniela Mercury... | pt.wi',
	},
	{
		src: 'https://d1o6h00a1h5k7q.cloudfront.net/imagens/img_m/19008/8910026_1.jpg',
		no: 'Selos / Gravadoras',
		des: 'Discos Marcus Pereira',
	},
*/
...
/* capa (de disco) samp (ler) micr (ofone*/
...
let synA = [
	...
	},
	{
		...
		no: '🇺🇸 Minimoog',
		des: 'O sintetizador Moog nasceu analógico, ou seja, nada de bits, bytes… Ele tem natureza diferente de um synth em VST, que em suma é um software. O Minimoog foi um grande passo na música tecnológica, afinal, foi o 1º synth de fato "acessível" a músicos. 🖼️ Simulador de Minimoog em software | JoeSynth.wordpress.com',
	},
	{
		src: 'https://dailyanalog.com/wp-content/uploads/2018/12/Sequential-Circuits-Prophet-5-728x316.jpg',
		no: '🇺🇸 Sequential Prophet-5 ★1978',
...
var i0 = r(news);;		
var i1 = ran(90, 109); // i0 = primeiro artigo do topo; em ran() os dois números são o min e max
var i2 = ran(80, 89);
var i3 = ran(76, 79);
var i4 = ran(72, 75);
var i5 = ran(85, 89);
...
/* Vide comentário em musi.js. Mas, basicamente, .conte1 escolhe a página news.js, e não outras como musi.js ou loca.js */
var im = document.querySelectorAll(".conte1 #arti .mmm");
var p = document.querySelectorAll(".conte1 #arti .ti");
var pre = document.querySelectorAll(".conte1 #arti .te");


/* a = artigo, cada div de conteúdo; i = índice do array de objetos (nome) */
function escre (a, i) {

	var rrr  = Math.floor(Math.random() * i.length);

	im[a].src = i[rrr].src;
	p[a].innerHTML = i[rrr].no;
	pre[a].innerHTML = i[rrr].des;
}
...
/* = objeto, nome do array de objeto */
function escreTrio (a, i, o) {
	im[a].src = o[i].src;
	p[a].innerHTML = o[i].no;
	pre[a].innerHTML = o[i].des;
}
...
/* 1º número = artigo; 2º = númeo q equivale ao índice de array de objeto, porém, está entrado um q equivale a faixa de números aleatórios*/
/*
traM transdutor monitor
traF transdutor  fone
bate beteria
datI data comemorativa instrumento musical
synT teoria
synA analógico
synD digital
synP pessoa
enge engenheiro
crav cravo
datP data comemorativa pessoa, profissão
datG data comemorativa gênero, estilo
*/
escre(0, news);
...
/* audio, livr (Software Livre) */
escre(16, synt);
escre(17, rock);
escre(18, audG);
escre(19, livr);

/* capa (de dsco) samp (pler) micr (ofone) */
escre(20, capa);
escre(21, samp);
escre(22, midi);
escre(23, micr);

/* rock vini pret matematíca naci literatura japa*/
...
escre(33, enge);
	...
	/* há outro trio de querySelectorAll acima, porém, se usar ele e não este criado aqui então não temos o efeito desejado*/
var imB = document.querySelectorAll(".conte1 #arti .mmm");
var pB = document.querySelectorAll(".conte1 #arti .ti");
var preB = document.querySelectorAll(".conte1 #arti .te");
/* Var abaixo, btSl32, dava erro quando o nome era btSl, este por sua vez, mesmo nome encontrado no arquivo musi.js, que tem um botão igual (também utilizando eventos) */
var btSl32 = document.querySelectorAll(".conte1 #arti .btSli");

/* o = objeto, ou melhor, nome do array de objetos*/
function btSliderNews (a, o) {

	//alert(a);
	var rr  = Math.floor(Math.random() * o.length);
	
	imB[a].src = o[rr].src;
	pB[a].innerHTML = o[rr].no;
	preB[a].innerHTML = o[rr].des;
}
