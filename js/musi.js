...
/* Banda Militar - https://pt.wikipedia.org/wiki/Banda_militar */
/* Banda Militar e Não Militar */
let banM = [
	{
...
let gene = [
	...
	},
	{
		...
		{
		src: 'thumb320x180.png',
		no: '🇺🇸 Punk Rock | meados anos 70',
		des: 'Gênero que se desenvolveu nos EUA e mais tarde em Londres, quando vários músicos excêntricos e escandalosos tocavam em um estilo deliberadamente cru e amadorístico, e esposavam sentimentos políticos nihilistas. Mais tarde transformou-se em um estilo "hardcore" brutal monocromático, tocado muito rápido e em volume altíssimo. | ft:Gro',
	},
];
...
/* .conte3 é vital no seletor. Note que, quando o HTML é escrito (lá em template.js), é escrito um modelo com várias tags para todas as telas (news, musi, loca). Porém, aqui, só queremos capturar pelo selectAll uma tela específica (musi, poe ex.) e com tdas as suas tags de artigo. */
