...
conteudo.innerHTML = "Akou é voltado a músicos e aqueles que, de fato, apreciam música.<br><br>Priorizando qualidade ao invés da quantidade, Akou oferece exemplos musicais (ou sonoros, no sentido estético) úteis para construir e estimular a audição do indivíduo, então dando referêmcias e conhecimento _ao invés do mero entretenimento.<br><h3>✔️ Akou proporciona só coisa boa!</h3>• Audição musical sem nos influenciar com imagens ou apelos visuais.<br>• Akou não é música como entretenimento, e sim alimento _educação, conhecimento.<br>• Akou funciona em segundo plano, permitindo ao usuário ouvir músicas e ainda sim usar outros apps.<br>• Akou tem baixíssimo con$umo da rede, dados.<br>• Uma música no Akou consome quase 10x menos que um mp3.<br><h3>✔️ Akou não visa propaganda</h3>• Sim! Akou tem zero de publicidade.<br><h3>✔️ Akou é FOSS!</h3>• Akou é construído no formato SL (software livre).<br>• Akou é seguro, não coletando dados do usuário.<br>• Akou não negocia dados do usuário, inclusive por não coletar.<br></br>Akou - 2022-2023<br><br>";
